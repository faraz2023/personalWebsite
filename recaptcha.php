    ...
    <div class="wrapper">
        ...
        <div class="content">
			...
			<?php require_once __DIR__ . '/php/recaptcha/autoload.php';				
				$siteKey = '6LcFH6kUAAAAAFNrRGL89rClGSUlfs2m8xxUWTaq'; // visit https://www.google.com/recaptcha/admin to generate keys
				$secret = '6LcFH6kUAAAAACUWzgUEhJR9RDyXiso3xo-FyT5w';
